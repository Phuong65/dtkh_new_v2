...
import { IctuPaginatorConfig, IctuPaginatorControl } from '@core-new/components/ictu-paginator/ictu-paginator-control';
import { DtoObject } from '@core-new/models/dto';
