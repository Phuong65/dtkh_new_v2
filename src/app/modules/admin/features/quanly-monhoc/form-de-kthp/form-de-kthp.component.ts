import { CourseFormKthpService } from './../../../../shared/services/course-form-kthp.service';
...
export class FormDeKthpComponent implements OnInit, OnChanges {
    ...
    saveType0() {
        ...
        this.list_course_plan.forEach(f => {
            ...
            Object.keys(f['question_take_private']).forEach(o => {
                if (f['question_take_private'][o]) {
                    const data = {
                        course_id: this._course.id,
                        week: f.week,
                        cdr: o,
                        total_question_take: f['question_take_private'][o],
                        private: 1
                    }
                    request.push(this.courseFormKthpService.addCourseFormKthp(data))
                }
