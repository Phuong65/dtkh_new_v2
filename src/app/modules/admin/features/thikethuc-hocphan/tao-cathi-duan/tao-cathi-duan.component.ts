...
import { SinhvienCathiDuanComponent } from "../sinhvien-cathi-duan/sinhvien-cathi-duan.component";
...
export class TaoCathiDuanComponent implements OnInit {
    ...
    initLoad() {
        ...
        const condition_course: ConditionOption = {
            condition: [
                ...
                { conditionName: 'params', condition: OvicQueryCondition.like, value: '%DUAN%', orWhere: 'and', },
            ],
            set: [
                { label: 'limit', value: '-1' },
    ...
    loadShiftsPage(page: number) {
        const condition_shift: ConditionOption = {
            ...
            set: [
                ...
                { label: 'with', value: 'user_created,shift_student_duan' },
            ],
    ...
    formReset() {
        ...
        this.list_form = null;
        this.isUpdate = false;
        this.f['type_of_test'].setValue('DUAN');
