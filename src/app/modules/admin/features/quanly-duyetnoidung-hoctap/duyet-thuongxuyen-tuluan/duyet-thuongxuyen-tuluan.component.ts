...
@Component({
    standalone: true,
    imports: [CommonModule, SharedModule, TableModule, CheckboxModule, ReactiveFormsModule, FormsModule, ButtonModule, RippleModule, TooltipModule, OverlayPanelModule],
...
export class DuyetThuongxuyenTuluanComponent implements OnInit, OnChanges {
