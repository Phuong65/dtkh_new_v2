...
const routes: Routes = [
    ...
    {
        path: 'lanhdao-khoa-gopy-all',
        loadComponent: () => import('@modules/admin/features/gop-y/gop-y-all/gop-y-all.component').then(c => c.GopYAllComponent),
    },
    {
        path: 'lanhdao-khoa-gopy-thongke',
        loadComponent: () => import('@modules/admin/features/gop-y/gop-y-thong-ke/gop-y-thong-ke.component').then(c => c.GopYThongKeComponent),
    },
];
...
export class LanhdaoKhoaRoutingModule { }
