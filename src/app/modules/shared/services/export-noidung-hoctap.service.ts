...
export class ExportNoidungHoctapService {
        ...
        Object.keys(objectExcel).forEach((fo, okey) => {
            ...
            objectExcel[fo]['header'].forEach((d, index) => {
                ...
                row.eachCell((cell, number) => {
                    cell.font = { name: 'Times New Roman', family: 1, size: 13 };
                });
            })
            ...
            objectExcel[fo]['dataTable'].forEach((d, index) => {
                ...
                row.font = rowFont;
                row.height = 31.13;
                let isBoldRow = typeof d[0] === 'number' && typeof d[1] === 'string' && d[1] === d[1].toUpperCase();
                console.log(isBoldRow);
