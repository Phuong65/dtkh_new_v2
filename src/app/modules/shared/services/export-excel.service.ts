...
export class ExportExcelService {
    ...
    public exportExcel(
        ...
        if (!where) {
            ...
            ws.getColumn(2).width = 36.53;
            ws.getColumn(3).width = 14.03;
            ws.getColumn(4).width = 14.03;
            ws.getColumn(5).width = 19.03;
            ws.getColumn(6).width = 14.03;
            ws.getColumn(7).width = 14.03;
            ws.getColumn(8).width = 20;
            ws.getColumn(9).width = 36.53;
            ws.getColumn(10).width = 36.53;
            ws.getColumn(11).width = 36.53;
            ws.getColumn(12).width = 36.53;
            ws.getColumn(13).width = 36.53;
        } else {
            ws.getRow(2).height = 37.5;
            ws.getRow(3).height = 31.13;
            ws.getColumn(1).width = 5.28;
