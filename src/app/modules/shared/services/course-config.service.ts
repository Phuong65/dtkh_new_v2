...
import { CourseConfig } from '../models/course-config';
...
export class CourseConfigService {
    ...
    addCourseConfig(data: any): Observable<any> {
        return this.http.post<Dto>(this.api, data).pipe(
            map(res => res.data)
        );
    }

    updateCourseConfig(deXuatId: number, data: any): Observable<any> {
        return this.http.put<Dto>(this.api.concat(deXuatId.toString()), data).pipe(
            map(res => res.data)
        );
    }

    getAllCourseConfig(): Observable<CourseConfig[]> {
    ...
    // getCourseConfigByShiftTestIds( col : string , item : string , condition : HttpParams ) {
    ...
    // countAllCourseConfig(): Observable<CourseConfig[]> {
    ...
    deleteCourseConfig(id: any): Observable<any> {
        return this.http.delete<Dto>(this.api.concat(id.toString())).pipe(
            map(res => res.data)
        );
    }

    deleteCourseConfigByClassHomeWorkId(id: number): Observable<any> {
        const by = new HttpParams().set('by', 'class_homework_id');
        return this.http.delete<Dto>(this.api.concat(id.toString()), { params: by });
    }

    // deleteCourseConfigByShiftTestId(id: any): Observable<any> {
    //     const by = new HttpParams().set('by', 'shift_test_id');
    //     return this.http.delete<Dto>(this.api.concat(id.toString()), { params: by });
    // }

    getCourseConfigByCol(col: string, item: any): Observable<CourseConfig[]> {
    ...
    getCourseConfigByCols(condition: HttpParams): Observable<CourseConfig[]> {
        return this.http.get<Dto>(this.api, { params: condition }).pipe(
            map(res => res.data)
        );
    }
    getCourseConfigByItem(item: string, col: string): Observable<CourseConfig[]> {
