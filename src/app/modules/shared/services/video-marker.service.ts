...
import { VideoMarker } from '../../shared/models/video-marker';
...
export class VideoMarkerService {
    ...
    private api = getRoute('video-marker/');
    ...
    addVideoMarker(data: any): Observable<any> {
        return this.http.post<Dto>(this.api, data).pipe(
            map(res => res.data)
        );
    }

    updateVideoMarker(deXuatId: any, data: any): Observable<any> {
        return this.http.put<Dto>(this.api.concat(deXuatId.toString()), data).pipe(
            map(res => res.data)
        );
    }

    getAllVideoMarkerByUserCreate(user_id: number): Observable<VideoMarker[]> {
        return this.http.get<Dto>(this.api.concat('?condition=creator_id,=,', user_id.toString())).pipe(
            map(res => res.data)
        );
    }

    getAllVideoMarker(): Observable<VideoMarker[]> {
    ...
    deleteVideoMarker(id: number): Observable<any> {
        return this.http.delete<Dto>(this.api.concat(id.toString())).pipe(
            map(res => res.data)
        );
    }

    getVideoMarkerByCol(col: string, item: string): Observable<VideoMarker[]> {
    ...
    getVideoMarkerByItem(item: string, col: string): Observable<VideoMarker[]> {
    ...
    deleteVideoMarkerByCol(id: string, col: string): Observable<any> {
    ...
    getVideoMarkerLenght(): Observable<any> {
    ...
    getVideoMarkerPage(start: number, limit: number): Observable<VideoMarker[]> {
    ...
    getVideoMarkerByCols(condition: HttpParams): Observable<VideoMarker[]> {
    ...
    getVideoMarkerByPageNew(option: ConditionOption): Observable<{ data: VideoMarker[], recordsFiltered: number }> {
