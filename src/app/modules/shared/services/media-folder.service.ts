...
import { MediaFolder } from '../../shared/models/media-folder';
...
export class MediaFolderService {
    ...
    private api = getRoute('media-folder/');
    ...
    addMediaFolder(data: any): Observable<any> {
        return this.http.post<Dto>(this.api, data).pipe(
            map(res => res.data)
        );
    }

    updateMediaFolder(deXuatId: any, data: any): Observable<any> {
        return this.http.put<Dto>(this.api.concat(deXuatId.toString()), data).pipe(
            map(res => res.data)
        );
    }

    getAllMediaFolderByUserCreate(user_id: number): Observable<MediaFolder[]> {
        return this.http.get<Dto>(this.api.concat('?condition=creator_id,=,', user_id.toString())).pipe(
            map(res => res.data)
        );
    }

    getAllMediaFolder(): Observable<MediaFolder[]> {
    ...
    deleteMediaFolder(id: number): Observable<any> {
        return this.http.delete<Dto>(this.api.concat(id.toString())).pipe(
            map(res => res.data)
        );
    }

    getMediaFolderByCol(col: string, item: string): Observable<MediaFolder[]> {
    ...
    getMediaFolderByItem(item: string, col: string): Observable<MediaFolder[]> {
    ...
    getMediaFolderLenght(): Observable<any> {
    ...
    getMediaFolderPage(start: number, limit: number): Observable<MediaFolder[]> {
    ...
    getMediaFolderByCols(condition: HttpParams): Observable<MediaFolder[]> {
    ...
    getMediaFolderByPageNew(option: ConditionOption): Observable<{ data: MediaFolder[], recordsFiltered: number }> {
