...
export class ExportDiemthuongxuyenService {
    ...
    exportExcel(data1: any[], data2: any[], clases: any, fileName: string, weekUse: number, header1: any[], header2: any[]) {
        ...
        if (data1 && sotinchi) {
            ...
            ws.getCell('A10').font = { bold: true, size: 12, name: 'Times New Roman', };
            ...
            ws.getCell('B10').value = 'Mã SV';
            ws.getCell('B10').alignment = { vertical: "middle", horizontal: 'center' };
            ws.getCell('B10').font = { bold: true, size: 11, name: 'Times New Roman', };
            ...
            ws.getCell('C10').value = 'Họ và Tên';
            ws.getCell('C10').alignment = { vertical: "middle", horizontal: 'center' };
            ws.getCell('C10').font = { bold: true, size: 11, name: 'Times New Roman', };
            ws.getCell('C10').border = {
                top: { style: 'thin' },
                left: { style: 'thin' },
                bottom: { style: 'thin' },
                right: { style: 'thin' },
            ...
            ws.getCell('D10').value = 'Ngày sinh';
            ws.getCell('D10').alignment = { vertical: "middle", horizontal: 'center' };
            ws.getCell('D10').font = { bold: true, size: 11, name: 'Times New Roman', };
            ws.getCell('D10').border = {
                top: { style: 'thin' },
                left: { style: 'thin' },
                bottom: { style: 'thin' },
                right: { style: 'thin' },
            ...
            if (sotinchi === 2) {
                ...
                ws.getCell('E10').value = 'Điểm';
                ws.getCell('E10').alignment = { vertical: "middle", horizontal: 'center' };
                ws.getCell('E10').font = { bold: true, size: 11, name: 'Times New Roman', };
            ...
            ws.getCell('E11').value = 'C.CẦN';
            ws.getCell('E11').alignment = { vertical: "middle", horizontal: 'center' };
            ws.getCell('E11').font = { bold: false, size: 10, name: 'Times New Roman', };
            ws.getCell('E10').border = {
                top: { style: 'thin' },
                left: { style: 'thin' },
                bottom: { style: 'thin' },
            ...
            ws.getCell('F11').value = 'TB CÁC BÀI TEST';
            ws.getCell('F11').alignment = { vertical: "middle", horizontal: 'center', wrapText: true };
            ws.getCell('F11').font = { bold: false, size: 10, name: 'Times New Roman', };
            ws.getCell('F11').border = {
                top: { style: 'thin' },
                left: { style: 'thin' },
                bottom: { style: 'thin' },
                right: { style: 'thin' },
            ...
            if (sotinchi === 2) {
                ws.getCell('G11').value = 'BÀI 1';
                ws.getCell('G11').alignment = { vertical: "middle", horizontal: 'center' };
                ws.getCell('G11').font = { bold: false, size: 10, name: 'Times New Roman', };
                ...
                ws.getCell('H11').value = 'BÀI 2';
                ws.getCell('H11').alignment = { vertical: "middle", horizontal: 'center' };
                ws.getCell('H11').font = { bold: false, size: 10, name: 'Times New Roman', };
                ...
                ws.getCell('I10').value = 'TX';
                ws.getCell('I10').alignment = { vertical: "middle", horizontal: 'center' };
                ws.getCell('I10').font = { bold: true, size: 10, name: 'Times New Roman', };
                ...
                ws.mergeCells('J10:J11');
                ws.getCell('J10').value = 'Ghi chú';
                ws.getCell('J10').alignment = { vertical: "middle", horizontal: 'center' };
                ws.getCell('J10').font = { bold: true, size: 10, name: 'Times New Roman', };
            ...
            if (sotinchi === 3) {
                ...
                ws.getCell('I11').value = 'BÀI 3';
                ws.getCell('I11').alignment = { vertical: "middle", horizontal: 'center' };
                ws.getCell('I11').font = { bold: false, size: 10, name: 'Times New Roman', };
                ws.getCell('I11').border = {
                    top: { style: 'thin' },
                    left: { style: 'thin' },
                    bottom: { style: 'thin' },
                    right: { style: 'thin' },
                ...
                ws.getCell('K10').value = 'Ghi chú';
                ws.getCell('K10').alignment = { vertical: "middle", horizontal: 'center' };
                ws.getCell('K10').font = { bold: true, size: 10, name: 'Times New Roman', };
            ...
            if (sotinchi === 4) {
                ...
                ws.getCell('J11').value = 'BÀI 4';
                ws.getCell('J11').alignment = { vertical: "middle", horizontal: 'center' };
                ws.getCell('J11').font = { bold: false, size: 10, name: 'Times New Roman', };
                ws.getCell('J11').border = {
                    top: { style: 'thin' },
                    left: { style: 'thin' },
                    bottom: { style: 'thin' },
                    right: { style: 'thin' },
                ...
                ws.getCell('L10').value = 'Ghi chú';
                ws.getCell('L10').alignment = { vertical: "middle", horizontal: 'center' };
                ws.getCell('L10').font = { bold: true, size: 10, name: 'Times New Roman', };
            ...
            const curentRow = 10 + data1.length + 1 + 1;
            ws.addRow('');
            ...
            ws.getCell('B' + (curentRow + 7 + 1)).value = '1. CC là cột điểm thường xuyên bao gồm: (5% điểm chuyên cần + 15% điểm TB các bài kiểm tra 15 phút đầu giờ + 30% TB các kiểm tra) x 2.';
        ...
        if (data2 && sotinchi) {
            ...
            ws.getCell('B9:B10').value = 'Mã Sinh viên';
            ...
            if (sotinchi === 2) {
                ws.mergeCells('F9:K9');
                ws.getCell('F9:K9').value = 'Điểm bài kiểm tra 15 phút đầu giờ';
                ws.getCell('F9:K9').alignment = { vertical: "middle", horizontal: 'center' };
                ws.getCell('F9:K9').font = { bold: true, size: 11, name: 'Times New Roman', };
                ws.getCell('F9:K9').border = {
                    top: { style: 'thin' },
                    left: { style: 'thin' },
                    bottom: { style: 'thin' },
                    right: { style: 'thin' },
                ...
                ws.mergeCells('L9:M9');
                ws.getCell('L9:M9').value = ' Điểm thường xuyên ';
                ws.getCell('L9:M9').alignment = { vertical: "middle", horizontal: 'center' };
                ws.getCell('L9:M9').font = { bold: true, size: 11, name: 'Times New Roman', };
                ws.getCell('L9:M9').border = {
                    top: { style: 'thin' },
                    left: { style: 'thin' },
                    bottom: { style: 'thin' },
                    right: { style: 'thin' },
                ...
                ws.getCell('N9:N10').value = ' CC ';
                ws.getCell('N9:N10').alignment = { vertical: "middle", horizontal: 'center' };
                ws.getCell('N9:N10').font = { bold: true, size: 11, name: 'Times New Roman', };
                ws.getCell('N9:N10').border = {
                    top: { style: 'thin' },
                    left: { style: 'thin' },
                    bottom: { style: 'thin' },
                    right: { style: 'thin' },
                ...
                ws.getCell('O9:O10').value = ' Ghi chú ';
                ws.getCell('O9:O10').alignment = { vertical: "middle", horizontal: 'center' };
                ws.getCell('O9:O10').font = { bold: true, size: 11, name: 'Times New Roman', };
                ws.getCell('O9:O10').border = {
                    top: { style: 'thin' },
                    left: { style: 'thin' },
                    bottom: { style: 'thin' },
                    right: { style: 'thin' },
                ...
                ws.getCell('P9:P10').value = ' Ghi chú ';
                ws.getCell('P9:P10').alignment = { vertical: "middle", horizontal: 'center' };
                ws.getCell('P9:P10').font = { bold: true, size: 11, name: 'Times New Roman', };
                ws.getCell('P9:P10').border = {
                    top: { style: 'thin' },
                    left: { style: 'thin' },
                    bottom: { style: 'thin' },
                    right: { style: 'thin' },
            ...
            if (sotinchi === 3) {
                ws.mergeCells('F9:N9');
                ws.getCell('F9:N9').value = 'Điểm bài 15 phút đầu giờ';
                ws.getCell('F9:N9').alignment = { vertical: "middle", horizontal: 'center' };
                ws.getCell('F9:N9').font = { bold: true, size: 11, name: 'Times New Roman', };
                ws.getCell('F9:N9').border = {
                    top: { style: 'thin' },
                    left: { style: 'thin' },
                    bottom: { style: 'thin' },
                    right: { style: 'thin' },
                ...
                ws.mergeCells('O9:Q9');
                ws.getCell('O9:Q9').value = ' Điểm thường xuyên ';
                ws.getCell('O9:Q9').alignment = { vertical: "middle", horizontal: 'center' };
                ws.getCell('O9:Q9').font = { bold: true, size: 11, name: 'Times New Roman', };
                ws.getCell('O9:Q9').border = {
                    top: { style: 'thin' },
                    left: { style: 'thin' },
                    bottom: { style: 'thin' },
                    right: { style: 'thin' },
                ...
                ws.getCell('R9:R10').value = ' CC ';
                ws.getCell('R9:R10').alignment = { vertical: "middle", horizontal: 'center' };
                ws.getCell('R9:R10').font = { bold: true, size: 11, name: 'Times New Roman', };
                ws.getCell('R9:R10').border = {
                    top: { style: 'thin' },
                    left: { style: 'thin' },
                    bottom: { style: 'thin' },
                    right: { style: 'thin' },
                ...
                ws.getCell('S9:S10').value = ' Số buổi nghỉ ';
                ws.getCell('S9:S10').alignment = { vertical: "middle", horizontal: 'center' };
                ws.getCell('S9:S10').font = { bold: true, size: 11, name: 'Times New Roman', };
                ws.getCell('S9:S10').border = {
                    top: { style: 'thin' },
                    left: { style: 'thin' },
                    bottom: { style: 'thin' },
                    right: { style: 'thin' },
                ...
                ws.getCell('T9:T10').value = ' Ghi chú ';
                ws.getCell('T9:T10').alignment = { vertical: "middle", horizontal: 'center' };
                ws.getCell('T9:T10').font = { bold: true, size: 11, name: 'Times New Roman', };
                ws.getCell('T9:T10').border = {
                    top: { style: 'thin' },
                    left: { style: 'thin' },
                    bottom: { style: 'thin' },
                    right: { style: 'thin' },
            ...
            if (sotinchi === 4) {
                ws.mergeCells('F9:Q9');
                ws.getCell('F9:Q9').value = 'Điểm bài 15 phút đầu giờ';
                ws.getCell('F9:Q9').alignment = { vertical: "middle", horizontal: 'center' };
                ws.getCell('F9:Q9').font = { bold: true, size: 11, name: 'Times New Roman', };
                ws.getCell('F9:Q9').border = {
                    top: { style: 'thin' },
                    left: { style: 'thin' },
                    bottom: { style: 'thin' },
                    right: { style: 'thin' },
                ...
                ws.mergeCells('R9:U9');
                ws.getCell('R9:U9').value = ' Điểm thường xuyên ';
                ws.getCell('R9:U9').alignment = { vertical: "middle", horizontal: 'center' };
                ws.getCell('R9:U9').font = { bold: true, size: 11, name: 'Times New Roman', };
                ws.getCell('R9:U9').border = {
                    top: { style: 'thin' },
                    left: { style: 'thin' },
                    bottom: { style: 'thin' },
                    right: { style: 'thin' },
                ...
                ws.getCell('V9:V10').value = ' CC ';
                ws.getCell('V9:V10').alignment = { vertical: "middle", horizontal: 'center' };
                ws.getCell('V9:V10').font = { bold: true, size: 11, name: 'Times New Roman', };
                ws.getCell('V9:V10').border = {
                    top: { style: 'thin' },
                    left: { style: 'thin' },
                    bottom: { style: 'thin' },
                    right: { style: 'thin' },
                ...
                ws.getCell('W9:W10').value = 'Số buổi nghỉ ';
                ws.getCell('W9:W10').alignment = { vertical: "middle", horizontal: 'center' };
                ws.getCell('W9:W10').font = { bold: true, size: 11, name: 'Times New Roman', };
                ws.getCell('W9:W10').border = {
                    top: { style: 'thin' },
                    left: { style: 'thin' },
                    bottom: { style: 'thin' },
                    right: { style: 'thin' },
                ...
                ws.getCell('X9:X10').value = 'Ghi chú ';
                ws.getCell('X9:X10').alignment = { vertical: "middle", horizontal: 'center' };
                ws.getCell('X9:X10').font = { bold: true, size: 11, name: 'Times New Roman', };
                ws.getCell('X9:X10').border = {
                    top: { style: 'thin' },
                    left: { style: 'thin' },
                    bottom: { style: 'thin' },
                    right: { style: 'thin' },
                ...
                ws.getCell('U10').value = ' TX4 ';
                ws.getCell('U10').alignment = { vertical: "middle", horizontal: 'center' };
                ws.getCell('U10').font = { bold: false, size: 10, name: 'Times New Roman', };
                ws.getCell('U10').border = {
                    top: { style: 'thin' },
                    left: { style: 'thin' },
                    bottom: { style: 'thin' },
                    right: { style: 'thin' },
