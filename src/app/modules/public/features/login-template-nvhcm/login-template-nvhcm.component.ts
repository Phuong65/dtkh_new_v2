...
@Component({
    selector: 'app-login-template-nvhcm',
    templateUrl: './login-template-nvhcm.component.html',
    styleUrls: ['./login-template-nvhcm.component.css']
})
export class LoginTemplateNvhcmComponent implements OnInit {
