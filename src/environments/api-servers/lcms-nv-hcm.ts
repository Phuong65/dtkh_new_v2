export const url_servers = {
    ...
    pageTitle: '[LCMS] - Hệ thống quản lý học tập trực tuyến, Nhạc viện thành phố Hồ Chí Minh',
    ...
    video_marker: true,
    donviquanly: 'Bộ văn hóa, thể thao và du lịch',
    donvitructhuoc: 'Nhạc viện thành phố Hồ Chí Minh',
    class_main: 'nv-hcm-color',
